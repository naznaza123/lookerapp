			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class=" {{ request()->is('homepage') ? 'active':'' }} "><a href="{{ url('homepage') }}">Home</a></li>
						<li class="{{ request()->is('my_post') ? 'active':'' }}"><a href="{{ url('my_post') }}">My Post</a></li>
						{{-- <li><a href="#">Categories</a></li> --}}
						{{-- <li><a href="#">Laptops</a></li> --}}
						{{-- <li><a href="#">Smartphones</a></li> --}}
						<li class="{{ request()->is('create_post') ? 'active':'' }}"><a href="{{ url('create_post') }}">Create post</a></li>
						{{-- <li class="{{ request()->is('data_diri') ? 'active':'' }}"><a href="{{ url('data_diri') }}">data diri</a></li> --}}
						<li>
							{{-- <form action="{{ url('logout') }}" method="get"> --}}
								@csrf
								<a href="{{ url('/logout') }}" {{ Route::is('/admin') ? 'active' : '' }}>logout</a></li>
							{{-- </form> --}}
